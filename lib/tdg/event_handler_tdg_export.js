 ...
 */
class EventHandlerTdgExport extends Base{
...
module.exports.eventHandlerTdgExportFactory = function (options) {
	return new EventHandlerTdgExport(options);
};
module.exports.EventHandlerTdgExport = EventHandlerTdgExport;
